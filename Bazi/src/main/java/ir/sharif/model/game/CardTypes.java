...
public enum CardTypes {
    ...
    //this card has wrong info, MENNO_COEHOORN_2("Menno Coehoorn", 10, 1, CardPosition.CLOSE_COMBAT_UNIT, new Medic(), Faction.NILFGAARDIAN_EMPIRE, false),
    ...
    //no phto fir this, SIEGE_TECHNICIAN("Siege Technician", 0, 1, CardPosition.SIEGE_UNIT, new Medic(), Faction.NILFGAARDIAN_EMPIRE, false),
    ...
    //We didn't have an img for it even in our assets, ARACHAS("Arachas", 4, 3, CardPosition.CLOSE_COMBAT_UNIT, new Muster(), Faction.MONSTERS, false),
