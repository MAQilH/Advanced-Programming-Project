...
public enum CardTypes {
    ...
    CERYS("Cerys", 10, 1, CardPosition.CLOSE_COMBAT_UNIT, new Muster(), Faction.SKELLIGE, false),
    KAMBI("Kambi", 11, 1, CardPosition.CLOSE_COMBAT_UNIT, new Transformers(), Faction.SKELLIGE, false),
    ...
    ERMION("Ermion", 8, 1, CardPosition.RANGED_UNIT, new Mardroeme(), Faction.SKELLIGE, false),
    HJALMAR("Hjalmar", 10, 1, CardPosition.RANGED_UNIT, null, Faction.SKELLIGE, false),
    ...
    IORVETH("Iorveth", 10, 1, CardPosition.RANGED_UNIT, null, Faction.SCOIATAEL, false),
    ...
    SEASENTHESSIS("Seasenthessis", 10, 1, CardPosition.RANGED_UNIT, null, Faction.SCOIATAEL, false),
    ...
    EITHNE("Eithne", 10, 1, CardPosition.RANGED_UNIT, null, Faction.SCOIATAEL, false),
    ...
    ESTERAD_THYSSEN("Esterad Thyssen", 10, 1, CardPosition.CLOSE_COMBAT_UNIT, null, Faction.NORTHEN_REALMS, false),
    JOHN_NATALIS("John Natalis", 10, 1, CardPosition.CLOSE_COMBAT_UNIT, null, Faction.NORTHEN_REALMS, false),
    ...
    PHILIPPA_EILHART("Philippa Eilhart", 10, 1, CardPosition.RANGED_UNIT, null, Faction.NORTHEN_REALMS, false),
    ...
    VERNON_ROCHE("Vernon Roche", 10, 1, CardPosition.CLOSE_COMBAT_UNIT, null, Faction.NORTHEN_REALMS, false),
    ...
    MENNO_COEHOORN("Menno Coehorn", 10, 1, CardPosition.CLOSE_COMBAT_UNIT, new Medic(), Faction.NILFGAARDIAN_EMPIRE, false),
    ...
    TIBOR_EGGEBRACHT("Tibor Eggebracht", 10, 1, CardPosition.RANGED_UNIT, null, Faction.NILFGAARDIAN_EMPIRE, false),
    ...
    MORVRAN_VOORHIS("Morvran Voorhis", 10, 1, CardPosition.SIEGE_UNIT, null, Faction.NILFGAARDIAN_EMPIRE, false),
    ...
    MORVRAN_VOORHIS_2("Morvran Voorhis", 10, 1, CardPosition.SIEGE_UNIT, null, Faction.NILFGAARDIAN_EMPIRE, false),
    ...
    GERALT_OF_RIVIA("Geralt of Rivia", 15, 1, CardPosition.CLOSE_COMBAT_UNIT, null, null, false),
    ...
    TRISS_MERIGOLD("Triss Merigold", 7, 1, CardPosition.CLOSE_COMBAT_UNIT, null, null, false),
